...
def normalize_single_dict(row: dict):
    ...
    for sequence_index in range(sequence_size):
        ...
        for identifier in BODY_IDENTIFIERS:
            ...
            # print("starting_point and ending_point:", (starting_point, ending_point))
            # print("diff0 and diff1: ", (ending_point[0] - starting_point[0], starting_point[1] - ending_point[1]))
